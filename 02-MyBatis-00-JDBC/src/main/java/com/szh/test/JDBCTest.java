...
public class JDBCTest {
    ...
    public void testSelect(){
        try{
            ...
            String url = "jdbc:mysql://localhost:3306/school?useSSL=false&characterEncoding=UTF8";
            String username = "root";
            String password = "5211314szh";
    ...
    public void testAdd() {
        try {
            ...
            // 准备参数
            String url = "jdbc:mysql://localhost:3306/school?useSSL=false&useUnicode=true&characterEncoding=UTF8";
            String username = "root";
            String password = "5211314szh";
