...
public class UserServiceImpl implements UserService {
    ...
    public ReturnMessageVO add(User user) {
        ...
        if (affectedRows > 0) {
            vo = new ReturnMessageVO(2200, "添加用户成功！！", true, user);
        } else {
    ...
    public ReturnMessageVO getlist(Integer pageNo, Integer pageSize, Long id) {
        ...
        if(id!=null){
            ...
            if (userList.size() == 0){
                ...
                returnMessageVO = new ReturnMessageVO(2200,"用户查询成功！！",true,userDataVO);
    ...
    public ReturnMessageVO update(User user) {
        ...
        if (affectedRows>0){
            ...
            returnMessageVO=new ReturnMessageVO(2000,"用户修改成功！！！",true,users);
        }else {
    ...
    public ReturnMessageVO del(Long id) {
        ...
        if (affectedRows>0){
            vo=new ReturnMessageVO(2000,"用户删除成功！！",true,null);
        }else {
